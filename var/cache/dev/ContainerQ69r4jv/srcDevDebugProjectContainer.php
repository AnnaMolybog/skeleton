...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            'app\\appbundle\\appbundle' => 'App\\AppBundle\\AppBundle',
            'app\\appbundle\\controller\\homepagecontroller' => 'App\\AppBundle\\Controller\\HomePageController',
        ...
        $this->methodMap = array(
            ...
            'debug.security.firewall' => 'getDebug_Security_FirewallService',
        ...
        $this->fileMap = array(
            'App\\AppBundle\\AppBundle' => __DIR__.'/getAppBundleService.php',
            'App\\AppBundle\\Controller\\HomePageController' => __DIR__.'/getHomePageControllerService.php',
            ...
            'security.authentication.listener.anonymous.ajax_calls' => __DIR__.'/getSecurity_Authentication_Listener_Anonymous_AjaxCallsService.php',
            'security.authentication.listener.anonymous.main' => __DIR__.'/getSecurity_Authentication_Listener_Anonymous_MainService.php',
            'security.authentication.provider.anonymous.ajax_calls' => __DIR__.'/getSecurity_Authentication_Provider_Anonymous_AjaxCallsService.php',
            ...
            'security.encoder_factory.generic' => __DIR__.'/getSecurity_EncoderFactory_GenericService.php',
            'security.firewall.map.context.ajax_calls' => __DIR__.'/getSecurity_Firewall_Map_Context_AjaxCallsService.php',
            ...
            'security.request_matcher.m0msdvr' => __DIR__.'/getSecurity_RequestMatcher_M0msdvrService.php',
        ...
        $this->privates = array(
            ...
            'security.authentication.listener.anonymous.ajax_calls' => true,
            'security.authentication.listener.anonymous.main' => true,
            'security.authentication.manager' => true,
            'security.authentication.provider.anonymous.ajax_calls' => true,
...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MZ+cqR7dhY', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getTwigService()
    {
        ...
        $a = ${($_ = isset($this->services['debug.file_link_formatter']) ? $this->services['debug.file_link_formatter'] : $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL)) && false ?: '_'};
        ...
        $instance->addGlobal('service_name', 'Skeleton Project');
        $instance->addGlobal('enviroment', 'dev');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel')) && false ?: '_'}, $this, $this->getParameterBag(), ($this->targetDirs[3].'/src/../web'), true);
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kcDIXPolgU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+lPHq8zun+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('clg-uHqlN2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', array(0 => function () {
            return ${($_ = isset($this->services['debug.security.firewall']) ? $this->services['debug.security.firewall'] : $this->getDebug_Security_FirewallService()) && false ?: '_'};
        }, 1 => 'onKernelRequest'), 8);
    ...
    {
        return $this->services['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(${($_ = isset($this->services['security.firewall.map']) ? $this->services['security.firewall.map'] : $this->getSecurity_Firewall_MapService()) && false ?: '_'}, ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->getDebug_EventDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['security.logout_url_generator']) ? $this->services['security.logout_url_generator'] : $this->getSecurity_LogoutUrlGeneratorService()) && false ?: '_'});
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 1 => ${($_ = isset($this->services['security.authentication.provider.anonymous.ajax_calls']) ? $this->services['security.authentication.provider.anonymous.ajax_calls'] : $this->services['security.authentication.provider.anonymous.ajax_calls'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))) && false ?: '_'};
        }, 2), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.ajax_calls' => function () {
            return ${($_ = isset($this->services['security.firewall.map.context.ajax_calls']) ? $this->services['security.firewall.map.context.ajax_calls'] : $this->load(__DIR__.'/getSecurity_Firewall_Map_Context_AjaxCallsService.php')) && false ?: '_'};
            ...
            yield 'security.firewall.map.context.ajax_calls' => ${($_ = isset($this->services['security.request_matcher.m0msdvr']) ? $this->services['security.request_matcher.m0msdvr'] : $this->services['security.request_matcher.m0msdvr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/_wdt')) && false ?: '_'};
        }, 2));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'assetic.read_from': $value = ($this->targetDirs[3].'/src/../web'); break;
            case 'assetic.write_to': $value = ($this->targetDirs[3].'/src/../web'); break;
